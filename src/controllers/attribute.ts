...
import Attribute, { IAttribute } from '../models/mongo_attribute'
...
const exportResult = {
  ...
  async create(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const data: IAttribute = req.body
      const result = await Attribute.add(data)
  ...
  async list(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const result = await Attribute.list(query)
      res.result = result
      next(res)
    }
    catch (err) { next(err) }
  ...
  async details(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      // const result = await Sample.details(attributeId)

      // Get your custom method
      const result = await Attribute.greetings(attributeId)
  ...
  async update(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const attributeId: string = req.params.attributeId
      const result = await Attribute.updateById(attributeId, req.body)
      res.result = (result as any)._doc
      next(res)
    }
    catch (err) { next(err) }
  ...
  async archive(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const attributeId: string = req.params.attributeId
      const result = await Attribute.softDelete(attributeId)
      res.result = (result as any)._doc
      next(res)
    }
    catch (err) { next(err) }
  ...
  async delete(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const attributeId: string = req.params.attributeId
      const result = await Attribute.remove(attributeId)
      res.result = result
      next(res)
    }
    catch (err) { next(err) }
  ...
  async secureAction(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const attributeId: string = req.params.attributeId
      const result = await Attribute.details(attributeId)
      res.result = (result as any)._doc
      next(res)
    }
    catch (err) { next(err) }
